...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">Pilih "Logout" untuk mengahiri sesi anda.</div>
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
            <a class="btn btn-primary" href="<?php echo base_url('utama/action_logout'); ?>">Logout</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="<?php echo base_url('home/admin'); ?>">Selamat Datang <?php echo $this->session->userdata('nama');?></a>
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="<?php echo base_url('home/mypost')?>/<?php echo $this->session->userdata('username'); ?>">My Post</a>
            <a class="dropdown-item" href="<?php echo base_url('home/newpost'); ?>">New Post</a> 
          </div>
        </li>
      </ul>
      <!-- /.content-wrapper -->